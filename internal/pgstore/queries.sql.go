...
type ConfirmTripParams struct {
	IsConfirmed bool
	ID          uuid.UUID
}

func (q *Queries) ConfirmTrip(ctx context.Context, arg ConfirmTripParams) error {
	_, err := q.db.Exec(ctx, confirmTrip, arg.IsConfirmed, arg.ID)
	return err
}
